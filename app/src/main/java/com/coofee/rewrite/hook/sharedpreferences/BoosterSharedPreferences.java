...
import com.coofee.rewrite.hook.HookExecutors;
...
//    private static final ExecutorService SYNC_EXECUTOR = Executors.newCachedThreadPool();
    private static final Executor SYNC_EXECUTOR = HookExecutors.newOptimizedSingleThreadExecutor("SharedPreferencesLoader", Process.THREAD_PRIORITY_DEFAULT, true);
    private static final Executor WRITER_EXECUTOR = HookExecutors.newOptimizedSingleThreadExecutor("SharedPreferencesWriter", Process.THREAD_PRIORITY_DISPLAY, false);

    private static final Map<String, BoosterSharedPreferences> sSharedPreferencesMap = new ConcurrentHashMap<>();
    private static final Object SENTINEL = new Object();

    private final Map<OnSharedPreferenceChangeListener, Object> mListeners = Collections.synchronizedMap(new WeakHashMap<OnSharedPreferenceChangeListener, Object>());
...
//        mWriteExecutor = ShadowExecutors.newOptimizedSingleThreadExecutor(name);
        mWriteExecutor = WRITER_EXECUTOR;
